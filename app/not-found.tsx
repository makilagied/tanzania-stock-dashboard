  ...
  return (
    <div className="relative flex min-h-screen flex-col overflow-hidden bg-gradient-to-br from-background via-background to-muted/20">
      ...
      <div className="pointer-events-none absolute inset-0" aria-hidden>
        ...
        <div className="not-found-float absolute left-[10%] top-[20%] opacity-20">
        ...
        <div className="not-found-float absolute right-[15%] top-[30%] opacity-20" style={{ animationDelay: "0.5s" }}>
        ...
        <div className="not-found-float absolute bottom-[30%] left-[20%] opacity-20" style={{ animationDelay: "1s" }}>
          <div className="flex items-center gap-2 rounded-lg border border-emerald-500/30 bg-emerald-500/10 px-3 py-1.5">
        ...
        <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-4 sm:px-6">
          ...
          <div className="flex items-center gap-1 sm:gap-2">
            <div className="flex items-center gap-2 text-xs text-muted-foreground">
              <LineChart className="h-4 w-4 shrink-0 text-emerald-500" aria-hidden />
          ...
          <div className="relative overflow-hidden rounded-3xl border border-border/50 bg-card/80 shadow-2xl backdrop-blur-xl">
            ...
            <div className="flex h-12 items-center gap-3 border-b border-border/50 bg-muted/30 px-5">
              ...
              <div className="flex-1 text-center">
                <span className="text-xs font-medium text-muted-foreground">Are you lost?</span>
              </div>
            </div>
            ...
            <div className="p-8 text-center sm:p-10">
              ...
              {/* <div className="mb-4 inline-flex items-center gap-2 rounded-full bg-rose-500/10 px-4 py-1.5 text-rose-600 dark:text-rose-400">
                ...
                <span className="text-xs font-bold uppercase tracking-wider">Bullish on typos</span>
              </div> */}
              ...
              <p className="mt-4 text-muted-foreground">
                Dead URL walking. Pick a destination below — the real action&apos;s one click away.
              </p>
